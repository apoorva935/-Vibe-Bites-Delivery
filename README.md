...
## 📸 Usage Guide
1.  **Login:** Enter your name on the neon login screen to start.
2.  **Browse:** Select a mood pill (e.g., "Comfort") or search for "Biryani".
3.  **Order:** Click **Add +** on items to fill your cart.
4.  **Checkout:** Open the cart, enter an address, and hit "Confirm Order".
5.  **Track:** Watch the delivery scooter animation and countdown timer!

## 🔮 Future Improvements
* [ ] Backend integration (Node.js) for real user authentication.
* [ ] Payment Gateway integration.
* [ ] Light Mode toggle.

---
Made with ❤️ and code by Apoorva
